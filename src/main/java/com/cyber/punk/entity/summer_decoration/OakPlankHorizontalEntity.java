package com.cyber.punk.entity.summer_decoration;
...
public class OakPlankHorizontalEntity extends TileEntity {
    private BlockPos mainPos;

    public OakPlankHorizontalEntity() {
        super(Entites.OAK_PLANK_HORIZONTAL.get());
