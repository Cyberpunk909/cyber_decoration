package com.cyber.punk.entity.dungeon_decoration;
...
public class DungeonWoodChairWithBoneEntity extends TileEntity {
    private BlockPos mainPos;
    public DungeonWoodChairWithBoneEntity() {
        super(Entites.DUNGEON_WOOD_CHAIR_WITH_BONE.get());
