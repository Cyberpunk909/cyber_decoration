...
import com.cyber.punk.entity.city_streets.TelephoneCabinEntity;
...
public class TelephoneCabin extends AbstractCustomBlock {
    public TelephoneCabin() {
        super(Properties.of(
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new TelephoneCabinEntity();
    }
