...
import com.cyber.punk.entity.city_streets.TrafficLightEntity;
...
public class TrafficLight extends AbstractCustomBlock {
    public TrafficLight() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(6.4564875, 21.694228144999997, 5.539250000000001, 9.681737499999999, 31.369978144999997, 10.7645),
            Block.box(7.6083625, 0.9604781449999994, 8.691125000000001, 8.5298625, 21.694228144999997, 9.612625000000001),
            Block.box(6.9172375, 0.4997281450000003, 8, 9.2209875, 0.9604781449999994, 10.30375),
            Block.box(6.4564875, 0, 7.539250000000001, 9.681737499999999, 0.4607500000000009, 10.7645)
