...
import com.cyber.punk.entity.city_streets.NewspaperVendingMachineEntity;
...
public class NewspaperVendingMachine extends AbstractCustomBlock {
    public NewspaperVendingMachine() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new NewspaperVendingMachineEntity();
    }
