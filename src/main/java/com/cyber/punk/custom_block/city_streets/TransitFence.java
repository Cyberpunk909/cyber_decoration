...
import com.cyber.punk.entity.city_streets.TransitFenceEntity;
...
public class TransitFence extends AbstractCustomBlock {
    public TransitFence() {
        super(Properties.of(
                        Material.METAL)
                .strength(1f,4.0f)
