...
import com.cyber.punk.entity.city_streets.TrashContainerEntity;
...
public class TrashContainer extends AbstractCustomBlock {
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new TrashContainerEntity();
    }
