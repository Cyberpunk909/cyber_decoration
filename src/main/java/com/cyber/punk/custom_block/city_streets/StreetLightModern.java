...
public class StreetLightModern extends AbstractCustomBlock {
    public StreetLightModern() {
        super(Properties.of(
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(5.799999999999999, -16, 5, 9.799999999999999, 18, 9),
                    Block.box(5.800000000000001, 18, -10.999999999999998, 9.8, 23, 9.000000000000002)
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new StreetLightModernEntity();
    }
