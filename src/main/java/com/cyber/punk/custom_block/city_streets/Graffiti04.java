...
import com.cyber.punk.entity.city_streets.Graffiti04Entity;
...
public class Graffiti04 extends AbstractCustomBlock {
    public Graffiti04() {
        super(Properties.of(
                        Material.DECORATION)
                .strength(1f,4.0f)
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(-16, 0, 15.98, 32, 27, 15.98)
