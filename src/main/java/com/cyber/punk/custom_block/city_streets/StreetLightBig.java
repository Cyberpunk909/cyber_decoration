...
import com.cyber.punk.entity.city_streets.StreetLightBigEntity;
...
public class StreetLightBig extends AbstractCustomBlock {
    public StreetLightBig() {
        super(Properties.of(
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(2.6000000000000005, -16, 4.500000000000002, 13.599999999999998, 27, 11.500000000000002)
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new StreetLightBigEntity();
    }
