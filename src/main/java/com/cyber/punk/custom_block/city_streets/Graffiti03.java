...
import com.cyber.punk.entity.city_streets.Graffiti03Entity;
...
public class Graffiti03 extends AbstractCustomBlock {
    public Graffiti03() {
        super(Properties.of(
                        Material.DECORATION)
                .strength(1f,4.0f)
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(-16, 0, 15.9, 32, 29, 15.9)
