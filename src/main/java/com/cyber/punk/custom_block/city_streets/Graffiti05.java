...
import com.cyber.punk.entity.city_streets.Graffiti05Entity;
...
public class Graffiti05 extends AbstractCustomBlock {
    public Graffiti05() {
        super(Properties.of(
                        Material.DECORATION)
                .strength(1f,4.0f)
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(-16, -6, 15.98, 32, 32, 15.98)
