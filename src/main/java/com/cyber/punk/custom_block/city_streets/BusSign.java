...
import com.cyber.punk.entity.city_streets.BusSignEntity;
...
public class BusSign extends AbstractCustomBlock {
    public BusSign() {
        super(Properties.of(
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(5, -16, 5, 10, 32, 10),
                    Block.box(10, 14, 7, 14, 23, 9)
