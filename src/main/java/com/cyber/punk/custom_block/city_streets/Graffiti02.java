...
import com.cyber.punk.entity.city_streets.Graffiti02Entity;
...
public class Graffiti02 extends AbstractCustomBlock {
    public Graffiti02() {
        super(Properties.of(
                        Material.DECORATION)
                .strength(1f,4.0f)
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(-16, -16, 15.98, 32, 32, 15.98)
