...
import com.cyber.punk.entity.city_streets.TrashContainerOpenEntity;
...
public class TrashContainerOpen extends AbstractCustomBlock {
    public TrashContainerOpen() {
        super(Properties.of(
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(-16, -16, 2, 16, 13, 28),
                    Block.box(-15.999999999999998, 13, 11, 1.7763568394002505e-15, 28, 28)
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new TrashContainerOpenEntity();
    }
