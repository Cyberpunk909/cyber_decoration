...
import com.cyber.punk.entity.city_streets.Graffiti01Entity;
...
public class Graffiti01 extends AbstractCustomBlock {
    public Graffiti01() {
        super(Properties.of(
                        Material.DECORATION)
                .strength(1f,4.0f)
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(-16, -16, 15.92, 32, 32, 15.92)
