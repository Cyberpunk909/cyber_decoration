...
import com.cyber.punk.entity.city_streets.FireHydrantEntity;
...
public class FireHydrant extends AbstractCustomBlock {
    public FireHydrant() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(11.5, 6.5, 5.5, 14.5, 11.5, 10.5),
            Block.box(14.25, 7.5, 6.5, 15.25, 10.5, 9.5),
            Block.box(0.75, 7.5, 6.5, 1.75, 10.5, 9.5),
            Block.box(5.5, 6.5, 1.5, 10.5, 11.5, 4.5),
            Block.box(12.25, 1.35, 9.5, 13.25, 2.35, 10.5),
            Block.box(2.75, 1.35, 9.5, 3.75, 2.35, 10.5),
            Block.box(2.75, 1.35, 5.5, 3.75, 2.35, 6.5),
            Block.box(12.25, 1.35, 5.5, 13.25, 2.35, 6.5),
            Block.box(9.5, 1.35, 2.75, 10.5, 2.35, 3.75),
            Block.box(5.5, 1.35, 2.75, 6.5, 2.35, 3.75),
            Block.box(5.5, 1.35, 12.25, 6.5, 2.35, 13.25),
            Block.box(9.5, 1.35, 12.25, 10.5, 2.35, 13.25),
            Block.box(1.5, 6.5, 5.5, 4.5, 11.5, 10.5),
            Block.box(2.5, 0, 2.5, 13.5, 2, 13.5),
            Block.box(7, 8, 0.5, 9, 10, 2.5),
            Block.box(7, 8, 13.5, 9, 10, 15.5),
            Block.box(5.5, 6.5, 11.5, 10.5, 11.5, 14.5),
            Block.box(4.5, 2, 4.5, 11.5, 14, 11.5),
            Block.box(3, 14, 3, 13, 16, 13),
            Block.box(4.5, 16, 4.5, 11.5, 19, 11.5),
            Block.box(6, 19, 6, 10, 21, 10)
