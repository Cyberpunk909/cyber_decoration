...
import com.cyber.punk.entity.office_decoration.OfficeWaterDispenserEntity;
...
public class OfficeWaterDispenser extends AbstractCustomBlock {
    public OfficeWaterDispenser() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new OfficeWaterDispenserEntity();
    }
