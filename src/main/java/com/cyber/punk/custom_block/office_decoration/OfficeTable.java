...
import com.cyber.punk.entity.office_decoration.OfficeTableEntity;
...
public class OfficeTable extends AbstractCustomBlock {
    public OfficeTable() {
        super(Properties.of(
                        Material.STONE)
                .strength(2f,4.0f)
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(-16, 0, 0, -4, 12, 16),
            Block.box(-16, 12, 0, 16, 14, 16),
            Block.box(0, 14, 0, 16, 24, 15),
            Block.box(14, 0, 0, 16, 12, 16),
            Block.box(-16, 14, 15, 16, 16, 16)
