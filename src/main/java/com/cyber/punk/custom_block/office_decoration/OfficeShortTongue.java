...
import com.cyber.punk.entity.office_decoration.OfficeShortTongueEntity;
...
public class OfficeShortTongue extends AbstractCustomBlock {
    public OfficeShortTongue() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            ...
            Block.box(2, 2, -1, 14, 11, 0),
            Block.box(2, 12, -1, 14, 21, 0),
            Block.box(2, 22, -1, 14, 31, 0)
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new OfficeShortTongueEntity();
    }
