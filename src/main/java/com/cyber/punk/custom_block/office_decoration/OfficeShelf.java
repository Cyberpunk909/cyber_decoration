...
import com.cyber.punk.entity.office_decoration.OfficeShelfEntity;
...
public class OfficeShelf extends AbstractCustomBlock {
    public OfficeShelf() {
        super(Properties.of(
                        Material.STONE)
                .strength(2f,4.0f)
