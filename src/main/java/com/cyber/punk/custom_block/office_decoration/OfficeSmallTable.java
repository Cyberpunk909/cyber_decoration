...
import com.cyber.punk.entity.office_decoration.OfficeSmallTableEntity;
...
public class OfficeSmallTable extends AbstractCustomBlock {
    public OfficeSmallTable() {
        super(Properties.of(
                        Material.WOOD)
                .strength(1f,4.0f)
                .noOcclusion());
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            ...
            Block.box(-16, 7, 0, 16, 9, 16),
            Block.box(13, 0, 1, 15, 7, 3),
            Block.box(-15, 0, 1, -13, 7, 3),
            Block.box(-15, 0, 13, -13, 7, 15),
            Block.box(13, 0, 13, 15, 7, 15)
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new OfficeSmallTableEntity();
    }
