...
import com.cyber.punk.entity.office_decoration.OfficeTVEntity;
...
public class OfficeTV extends AbstractCustomBlock {
    public OfficeTV() {
        super(Properties.of(
                        Material.STONE)
                .strength(2f,4.0f)
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(-16, 0, 14.5, 16, 1, 16.5),
            Block.box(-16, 15, 14.5, 16, 16, 16.5),
            Block.box(15, 1, 14.5, 16, 15, 16.5),
            Block.box(-16, 1, 14.5, -15, 15, 16.5),
            Block.box(-15, 1, 15.5, 15, 15, 16.5)
