...
import com.cyber.punk.entity.office_decoration.OfficeBigTableEntity;
...
public class OfficeBigTable extends AbstractCustomBlock {
    public OfficeBigTable() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(-16, 12, 0, 32, 14, 32),
                    Block.box(-12, 0, 4, 28, 12, 28)
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new OfficeBigTableEntity();
    }
