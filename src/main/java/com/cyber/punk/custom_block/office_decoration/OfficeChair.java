...
import com.cyber.punk.entity.office_decoration.OfficeChairEntity;
...
public class OfficeChair extends AbstractCustomBlock {
    public OfficeChair() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(2, 6, 4, 14, 9, 16),
            Block.box(2, 9, 14, 14, 18, 16),
            Block.box(14, 12, 5, 16, 13, 16),
            Block.box(14, 0, 5, 16, 12, 6),
            Block.box(14, 0, 15, 16, 12, 16),
            Block.box(14, 6, 6, 16, 8, 15),
            Block.box(0, 0, 5, 2, 12, 6),
            Block.box(0, 6, 6, 2, 8, 15),
            Block.box(0, 0, 15, 2, 12, 16),
            Block.box(0, 12, 5, 2, 13, 16)
