...
import com.cyber.punk.entity.office_decoration.OfficeArmchairEntity;
...
public class OfficeArmchair extends AbstractCustomBlock {
    public OfficeArmchair() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            ...
            Block.box(13, 9, 4, 14, 12, 6),
            Block.box(13, 12, 4, 14, 14, 14),
            Block.box(2, 12, 4, 3, 14, 14),
            Block.box(2, 9, 4, 3, 12, 6),
            Block.box(2, 9, 14, 14, 21, 16),
            Block.box(2, 0, 4, 14, 6, 16)
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new OfficeArmchairEntity();
    }
