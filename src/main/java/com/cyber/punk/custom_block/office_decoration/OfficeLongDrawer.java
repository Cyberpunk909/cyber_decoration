...
import com.cyber.punk.entity.office_decoration.OfficeLongDrawerEntity;
...
public class OfficeLongDrawer extends AbstractCustomBlock {
    public OfficeLongDrawer() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(-16, 0, 0, 16, 32, 16),
            Block.box(-8, 26.5, -1, 8, 28.5, 0),
            Block.box(-8, 16, -1, 8, 18, 0),
            Block.box(-8, 5.5, -1, 8, 7.5, 0)
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new OfficeLongDrawerEntity();
    }
