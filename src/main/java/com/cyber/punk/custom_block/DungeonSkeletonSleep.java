...
import com.cyber.punk.entity.DungeonSkeletonEntity;
...
public class DungeonSkeletonSleep extends AbstractCustomBlock {
    public DungeonSkeletonSleep() {
        super(Properties.of(
                        Material.STONE)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new DungeonSkeletonEntity();
    }
