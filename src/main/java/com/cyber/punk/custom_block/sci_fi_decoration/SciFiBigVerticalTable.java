...
import com.cyber.punk.entity.sci_fi_decoration.SciFiBigVerticalTableEntity;
import com.cyber.punk.entity.summer_decoration.OakPlankHorizontalEntity;
...
public class SciFiBigVerticalTable extends AbstractCustomBlock {
    public SciFiBigVerticalTable() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(28, 0, 1, 31, 14, 31),
            Block.box(-15, 0, 1, -12, 14, 31),
            Block.box(-16, 14, 0, 32, 16, 32),
            Block.box(-12, 6, 29, 28, 14, 30)
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new SciFiBigVerticalTableEntity();
    }
