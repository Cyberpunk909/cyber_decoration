...
import com.cyber.punk.entity.sci_fi_decoration.SciFiBigGlassTableEntity;
...
public class SciFiBigGlassTable extends AbstractCustomBlock {
    public SciFiBigGlassTable() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(9, 0, 1, 15, 14, 4),
            Block.box(-15, 0, 1, -9, 14, 4),
            Block.box(-15, 0, 28, 15, 14, 31),
            Block.box(-16, 14, 25, 16, 16, 32),
            Block.box(-16, 14, 0, 16, 15, 25)
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new SciFiBigGlassTableEntity();
    }
