...
import com.cyber.punk.entity.sci_fi_decoration.SciFiStoolEntity;
...
public class SciFiStool extends AbstractCustomBlock {
    public SciFiStool() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            ...
            Block.box(0, 10, 11, 16, 20, 16),
            Block.box(1, 8, 12, 15, 10, 16)
