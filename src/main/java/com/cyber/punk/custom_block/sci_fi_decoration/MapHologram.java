...
import com.cyber.punk.entity.dungeon_decoration.DungeonWoodThroneEntity;
import com.cyber.punk.entity.sci_fi_decoration.MapHologramEntity;
...
public class MapHologram extends AbstractCustomBlock {
    public MapHologram() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            ...
            Block.box(1, 10, 8, 15, 32, 8),
            Block.box(6.25, 19.5, 8.01, 9.25, 22.5, 8.01),
            Block.box(6.25, 19.5, 7.99, 9.25, 22.5, 7.99),
            Block.box(1, 3, 8, 15, 10, 8),
            Block.box(0, 0, 0, 0, 2, 16),
            Block.box(16, 0, 0, 16, 2, 16),
            Block.box(0, 0, 0, 16, 2, 0),
            Block.box(0, 0, 16, 16, 2, 16),
            Block.box(2, 2, 2, 14, 3, 3),
            Block.box(2, 2, 13, 14, 3, 14),
