...
import com.cyber.punk.entity.sci_fi_decoration.SciFiVerticalCableEntity;
...
public class SciFiVerticalCable extends AbstractCustomBlock {
    public SciFiVerticalCable() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new SciFiVerticalCableEntity();
    }
