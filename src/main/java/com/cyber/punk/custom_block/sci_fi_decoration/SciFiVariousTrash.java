...
import com.cyber.punk.entity.sci_fi_decoration.SciFiVariousTrashEntity;
...
public class SciFiVariousTrash extends AbstractCustomBlock {
    public SciFiVariousTrash() {
        super(Properties.of(
                        Material.DECORATION)
                .strength(0.5f,4.0f)
                .noOcclusion());
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new SciFiVariousTrashEntity();
    }
