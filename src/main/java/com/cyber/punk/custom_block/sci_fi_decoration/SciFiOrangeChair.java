...
import com.cyber.punk.entity.sci_fi_decoration.SciFiOrangeChairEntity;
...
public class SciFiOrangeChair extends AbstractCustomBlock {
    public SciFiOrangeChair() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new SciFiOrangeChairEntity();
    }
