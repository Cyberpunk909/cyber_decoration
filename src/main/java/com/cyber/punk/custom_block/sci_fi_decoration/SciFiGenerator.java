...
public class SciFiGenerator extends AbstractCustomBlock {
    public SciFiGenerator() {
        super(Properties.of(
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(6, 0, -3, 10, 3, 0),
            Block.box(0, 0, 0, 16, 16, 16),
            Block.box(7, 0, -16, 9, 2, -3),
            Block.box(1, 16, 3, 15, 24, 15),
            Block.box(3, 24, 10, 13, 31, 15)
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new SciFiGeneratorEntity();
    }
