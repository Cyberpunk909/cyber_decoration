...
import com.cyber.punk.entity.sci_fi_decoration.SciFiPlantEntity;
import com.cyber.punk.entity.sci_fi_decoration.SciFiSmallBinEntity;
...
public class SciFiSmallBin extends AbstractCustomBlock {
    public SciFiSmallBin() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(2, 22, 2, 14, 22, 10),
            Block.box(2, 14, 2, 14, 22, 2),
            Block.box(14, 14, 2, 14, 22, 10),
            Block.box(2, 14, 2, 2, 22, 10),
            Block.box(1, 0, 1, 15, 14, 15),
            Block.box(1, 14, 10, 15, 24, 15)
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new SciFiSmallBinEntity();
    }
