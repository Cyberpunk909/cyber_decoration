...
public class SciFiBigTable extends AbstractCustomBlock {
    public SciFiBigTable() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(12, 0, 1, 15, 14, 31),
            Block.box(-15, 0, 1, -12, 14, 31),
            Block.box(-16, 14, 0, 16, 16, 32),
            Block.box(-12, 11, 2, 12, 14, 3),
            Block.box(-12, 11, 29, 12, 14, 30)
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new SciFiBigTableEntity();
    }
