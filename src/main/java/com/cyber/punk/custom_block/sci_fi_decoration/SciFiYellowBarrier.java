...
import com.cyber.punk.entity.sci_fi_decoration.SciFiYellowBarrierEntity;
...
public class SciFiYellowBarrier extends AbstractCustomBlock {
    public SciFiYellowBarrier() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(-16, 0, 4, 16, 4, 11),
            Block.box(-14, 4, 7, 14, 14, 11),
            Block.box(10, 14, 8, 13, 17, 10),
            Block.box(-13, 14, 8, -10, 17, 10),
            Block.box(-16, 17, 8, 16, 24, 10)
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new SciFiYellowBarrierEntity();
    }
