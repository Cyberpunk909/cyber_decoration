...
import com.cyber.punk.entity.sci_fi_decoration.SciFiSignNightEntity;
...
public class SciFiSignNight extends AbstractCustomBlock {
    public SciFiSignNight() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            ...
            Block.box(2, 6, 6, 14, 9, 10),
            Block.box(3, 11, 7.5, 13, 32, 8.5)
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new SciFiSignNightEntity();
    }
