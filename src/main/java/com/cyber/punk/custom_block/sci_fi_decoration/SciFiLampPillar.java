...
import com.cyber.punk.entity.sci_fi_decoration.SciFiGeneratorEntity;
import com.cyber.punk.entity.sci_fi_decoration.SciFiLampPillarEntity;
...
public class SciFiLampPillar extends AbstractCustomBlock {
    public SciFiLampPillar() {
        super(Properties.of(
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(4, -15, 4, 12, -13, 12),
            Block.box(5, -13, 5, 11, -8, 11),
            Block.box(7, -8, 7, 9, 27, 9),
            Block.box(4, 23, -1, 12, 32, 11)
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new SciFiLampPillarEntity();
    }
