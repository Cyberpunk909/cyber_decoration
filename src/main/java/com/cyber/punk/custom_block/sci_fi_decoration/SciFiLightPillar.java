...
import com.cyber.punk.entity.sci_fi_decoration.SciFiLightPillarEntity;
...
public class SciFiLightPillar extends AbstractCustomBlock {
    public SciFiLightPillar() {
        super(Properties.of(
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new SciFiLightPillarEntity();
    }
