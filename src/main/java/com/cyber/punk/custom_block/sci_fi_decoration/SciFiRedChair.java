...
import com.cyber.punk.entity.sci_fi_decoration.SciFiBedEntity;
...
public class SciFiRedChair extends AbstractCustomBlock {
    public SciFiRedChair() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new SciFiRedChairEntity();
    }
