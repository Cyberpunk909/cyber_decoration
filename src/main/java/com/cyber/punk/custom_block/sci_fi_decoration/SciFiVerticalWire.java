...
import com.cyber.punk.entity.sci_fi_decoration.SciFiVerticalWireEntity;
...
public class SciFiVerticalWire extends AbstractCustomBlock {
    public SciFiVerticalWire() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new SciFiVerticalWireEntity();
    }
