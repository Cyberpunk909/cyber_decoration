...
import com.cyber.punk.entity.sci_fi_decoration.SciFiChairEntity;
...
public class SciFiChair extends AbstractCustomBlock {
    public SciFiChair() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
