...
import com.cyber.punk.entity.sci_fi_decoration.SciFiSignSunEntity;
...
public class SciFiSignSun extends AbstractCustomBlock {
    public SciFiSignSun() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            ...
            Block.box(4, 12, 7.25, 12, 31, 7.25),
            Block.box(-1, 12, 8, 3, 31, 8)
