...
import com.cyber.punk.entity.sci_fi_decoration.SciFiBlackChairEntity;
import com.cyber.punk.entity.sci_fi_decoration.SciFiRedChairEntity;
...
public class SciFiBlackChair extends AbstractCustomBlock {
    public SciFiBlackChair() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            ...
            Block.box(1, 22, 13, 15, 27, 15),
            Block.box(12, 15, 14, 13, 23, 16),
            Block.box(3, 15, 14, 4, 23, 16),
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new SciFiBlackChairEntity();
    }
