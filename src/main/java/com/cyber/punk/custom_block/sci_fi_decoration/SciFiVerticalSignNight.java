...
import com.cyber.punk.entity.sci_fi_decoration.SciFiVerticalSignNightEntity;
...
public class SciFiVerticalSignNight extends AbstractCustomBlock {
    public SciFiVerticalSignNight() {
        super(Properties.of(
                        Material.STONE)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(11, 0, 5, 16, 16, 11),
                    Block.box(-16, 2, 7.5, 10, 14, 8.5)
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new SciFiVerticalSignNightEntity();
    }
