...
import com.cyber.punk.entity.sci_fi_decoration.SciFiBigBinEntity;
import com.cyber.punk.entity.sci_fi_decoration.SciFiBigTableEntity;
...
public class SciFiBigBin extends AbstractCustomBlock {
    public SciFiBigBin() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(13, 0, 2, 16, 14, 32),
            Block.box(-14, 0, 2, -11, 14, 32),
            Block.box(-11, 0, 2, 13, 3, 32),
            Block.box(-11, 3, 23, 13, 14, 32),
            Block.box(-11, 3, 3, 13, 14, 5),
            Block.box(-14, 14, 23, 16, 24, 32),
            Block.box(5.5, 24, 25, 10.5, 27, 30),
            Block.box(-13, 22, 3, 15, 22, 23),
            Block.box(-13, 14, 3, 15, 22, 3),
            Block.box(15, 14, 3, 15, 22, 23),
            Block.box(-13, 14, 3, -13, 22, 23)
