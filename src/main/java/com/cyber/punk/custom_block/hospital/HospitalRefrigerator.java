...
import com.cyber.punk.entity.hospital.HospitalRefrigeratorEntity;
...
public class HospitalRefrigerator extends AbstractCustomBlock {
    public HospitalRefrigerator() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new HospitalRefrigeratorEntity();
    }
