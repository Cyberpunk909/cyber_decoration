...
import com.cyber.punk.entity.hospital.HospitalSupplyCabinetEntity;
...
public class HospitalSupplyCabinet extends AbstractCustomBlock {
    public HospitalSupplyCabinet() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new HospitalSupplyCabinetEntity();
    }
