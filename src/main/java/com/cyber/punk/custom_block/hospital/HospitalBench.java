...
import com.cyber.punk.entity.hospital.HospitalBenchEntity;
...
public class HospitalBench extends AbstractCustomBlock {
    public HospitalBench() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new HospitalBenchEntity();
    }
