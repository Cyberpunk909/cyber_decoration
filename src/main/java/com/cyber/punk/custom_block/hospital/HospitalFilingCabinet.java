...
import com.cyber.punk.entity.hospital.HospitalFilingCabinetEntity;
...
public class HospitalFilingCabinet extends AbstractCustomBlock {
    public HospitalFilingCabinet() {
        super(Properties.of(
                        Material.METAL)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new HospitalFilingCabinetEntity();
    }
