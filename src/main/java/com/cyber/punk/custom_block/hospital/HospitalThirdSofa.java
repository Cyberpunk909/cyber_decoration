...
import com.cyber.punk.entity.hospital.HospitalThirdSofaEntity;
...
public class HospitalThirdSofa extends AbstractCustomBlock {
    public HospitalThirdSofa() {
        super(Properties.of(
                        Material.WOOD)
                .strength(1f,4.0f)
                .noOcclusion());
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(-13, 0, 0, 29, 8, 16),
            Block.box(29, 0, 0, 32, 14, 16),
            Block.box(-16, 0, 0, -13, 14, 16),
            Block.box(-13, 8, 12, 29, 19, 16)
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new HospitalThirdSofaEntity();
    }
