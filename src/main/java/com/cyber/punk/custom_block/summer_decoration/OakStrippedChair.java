...
import com.cyber.punk.entity.summer_decoration.OakStrippedChairEntity;
...
public class OakStrippedChair extends AbstractCustomBlock {
    public OakStrippedChair() {
        super(Properties.of(
                        Material.WOOD)
                .strength(2f,4.0f)
                .noOcclusion());
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.box(-7.99, 5.99, 3, 7.99, 7.99, 13),
            Block.box(19.009999999999998, -0.01, 4, 21.990000000000002, 5.99, 12),
            Block.box(-5.99, -0.01, 4, -3.01, 5.99, 12),
            Block.box(8.01, 5.99, 3, 23.990000000000002, 7.99, 13)
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new OakStrippedChairEntity();
    }
