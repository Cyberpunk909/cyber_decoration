...
import com.cyber.punk.entity.dungeon_decoration.DungeonCageWithBoneEntity;
...
public class DungeonCageWithBone extends AbstractCustomBlock {
    public DungeonCageWithBone() {
        super(Properties.of(
                        Material.METAL)
                .strength(3f,4.0f)
                .noOcclusion());
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new DungeonCageWithBoneEntity();
    }
