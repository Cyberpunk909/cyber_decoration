...
import com.cyber.punk.entity.dungeon_decoration.DungeonWoodChairWithBoneEntity;
...
public class DungeonWoodChairWithBone extends AbstractCustomBlock {
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new DungeonWoodChairWithBoneEntity();
    }
