...
import com.cyber.punk.entity.dungeon_decoration.DungeonWeaponStandEntity;
...
public class DungeonWeaponStand extends AbstractCustomBlock {
    public DungeonWeaponStand() {
        super(Properties.of(
                        Material.STONE)
                .strength(3f,4.0f)
                .noOcclusion());
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new DungeonWeaponStandEntity();
    }
