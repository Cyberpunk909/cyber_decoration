...
public class SciFiWallLamp extends BlockUtils {
    public static final DirectionProperty FACING = HorizontalBlock.FACING;

    public SciFiWallLamp() {
    ...
    static {
        Stream<VoxelShape> shapeStream = Stream.of(
                Block.box(0, 7, 15, 16, 15, 16),
                Block.box(0, 0, 14.5, 16, 9, 14.5),
                Block.box(1, 9, 11, 15, 13, 15),
                Block.box(3, 8, 10, 4, 14, 15),
                Block.box(12, 8, 10, 13, 14, 15)
        );
